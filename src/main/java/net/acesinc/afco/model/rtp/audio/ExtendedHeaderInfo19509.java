 ...
 * @author jeremytaylor
 */
public class ExtendedHeaderInfo19509 extends SupportedExtendedHeaderInfo {

    private static final Logger log = LoggerFactory.getLogger(ExtendedHeaderInfo19509.class);
    ...
    public int getAgsExtHeaderPreambleProfileValue() {
        return ExtendedHeaderInfo.AGS_EXTENDED_HEADER_PROFILE_19509_PREAMBLE_VALUE;
    }
    ...
    public byte[] toBytes() {
        ...
        try (ByteArrayOutputStream bos = new ByteArrayOutputStream()) {
            // Explanation: Since everything before the 32-bit-frequency in the RTP extended header is a char, taking a
            // String and doing getBytes() for the byte[] will continue to be reasonable and convenient. The 32-bit
            // integer however will need to come packed right afterwards in the over-all raw byte array of the extended
            // header.
            ...
            // all chars before.
            bos.write(ExtendedHeaderInfo19509.uIntLongToByteWord(this.frequency));
            ...
            // at the end of it again. For now, there is no pad, but this first length should match up to the final
            // needed length.
     ...
     * @return ExtendedHeaderInfo19509
     */
    public static ExtendedHeaderInfo19509 toExtendedHeaderFromBytes(byte[] rawExtendedHeader) {
        log.trace("deserializing raw extension header bytes into ExtendedHeaderInfo instance...");
        if (rawExtendedHeader.length
                != ExtendedHeaderInfo19509.getSupportedProfileBytesLength(
        ...
        ExtendedHeaderInfo19509 tmp = new ExtendedHeaderInfo19509();
        ...
        tmp.setFrequency(ExtendedHeaderInfo19509.bytesToUIntLong(rawFrequency, 0));
        return tmp;
    }
    ...
    public String getOperatorId() {
        throw new UnsupportedOperationException(
                "RTP Extended Header Preamble Profile value 19509 does NOT support Operator ID!!!");
    }
    ...
    public Short getSignalType() {
        throw new UnsupportedOperationException(
                "RTP Extended Header Preamble Profile value 19509 does NOT support Signal Type!!!");
    }
    ...
    public long getSpecialField1() {
        throw new UnsupportedOperationException(
                "RTP Extended Header Preamble Profile value 19509 does NOT support SpecialField1!!!");
    }
    ...
    public String getSpecialField2() {
        throw new UnsupportedOperationException(
                "RTP Extended Header Preamble Profile value 19509 does NOT support SpecialField2!!!");
    }
