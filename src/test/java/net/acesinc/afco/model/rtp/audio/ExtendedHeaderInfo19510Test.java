 ...
 * @author jeremytaylor
 */
public class ExtendedHeaderInfo19510Test {

    private static final Logger log = LoggerFactory.getLogger(ExtendedHeaderInfo19510Test.class);
    ...
    public void testEncoding001() {
        log.debug("start");
        ExtendedHeaderInfo extHeaderInfo = new ExtendedHeaderInfo19510();
        ...
        assertThat(
                ...
                raw.length,
                is(equalTo(ExtendedHeaderInfo.ACTUAL_AGS_EXT_HEADER_PROFILE_19510_LENGTH_IN_BYTES)));
    ...
    public void testDecoding001() {
        ...
        ExtendedHeaderInfo received = SupportedExtendedHeaderInfo.toExtendedHeaderFromBytes(
                ExtendedHeaderInfo.AGS_EXTENDED_HEADER_PROFILE_19510_PREAMBLE_VALUE, raw);
