 ...
 * @author jeremytaylor
 */
public class ExtendedHeaderInfo19511Test {

    private static final Logger log = LoggerFactory.getLogger(ExtendedHeaderInfo19511Test.class);
    ...
    public void testEncoding001() {
        log.debug("start");
        ExtendedHeaderInfo extHeaderInfo = new ExtendedHeaderInfo19511();
        ...
        Integer freq = GenUtilities.getFreqInHertz();
        extHeaderInfo.setDeprecatedAsciiFrequency(GenUtilities.getFreqStrFromHertzValue(freq));
        ...
        extHeaderInfo.setFrequency(freq.longValue());
        extHeaderInfo.setOperatorId(GenUtilities.getOperatorID());
        extHeaderInfo.setSignalType(GenUtilities.getAudioSignalType());
        extHeaderInfo.setSpecialField1(GenUtilities.getSpecialField1());
        extHeaderInfo.setSpecialField2(GenUtilities.getSpecialField2());
        ...
        assertThat(
                ...
                raw.length,
                is(equalTo(ExtendedHeaderInfo.ACTUAL_AGS_EXT_HEADER_PROFILE_19511_LENGTH_IN_BYTES)));
    ...
    public void testDecoding001() {
        ...
        ExtendedHeaderInfo received = SupportedExtendedHeaderInfo.toExtendedHeaderFromBytes(
                ExtendedHeaderInfo.AGS_EXTENDED_HEADER_PROFILE_19511_PREAMBLE_VALUE, raw);
        ...
        assertThat(
                "wrong deprecatedAsciiFrequency",
        ...
        assertThat("wrong frequency", received.getFrequency(), is(equalTo(extHeaderInfo.getFrequency())));
        assertThat("wrong operatorId", received.getOperatorId(), is(equalTo(extHeaderInfo.getOperatorId())));
        assertThat("wrong signalType", received.getSignalType(), is(equalTo(extHeaderInfo.getSignalType())));
        assertThat("wrong specialField1", received.getSpecialField1(), is(equalTo(extHeaderInfo.getSpecialField1())));
        assertThat("wrong specialField2", received.getSpecialField2(), is(equalTo(extHeaderInfo.getSpecialField2())));
        log.debug("end");
    }
